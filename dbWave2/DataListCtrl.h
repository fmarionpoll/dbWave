...
public:
	...
	int GetVisibleRowsSize() { return ptrArray.GetSize(); }
	AcqDataDoc* GetVisibleRowsAcqDataDocAt(int index) { return ptrArray[index]->pdataDoc; }
	CSpikeDoc* GetVisibleRowsSpikeDocAt(int index) { return ptrArray[index]->pspikeDoc; }
