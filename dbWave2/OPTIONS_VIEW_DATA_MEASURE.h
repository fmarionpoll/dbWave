...
class OPTIONS_VIEW_DATA_MEASURE : public CObject
{
	DECLARE_SERIAL(OPTIONS_VIEW_DATA_MEASURE)
	OPTIONS_VIEW_DATA_MEASURE();
	~OPTIONS_VIEW_DATA_MEASURE() override;
	OPTIONS_VIEW_DATA_MEASURE& operator =(const OPTIONS_VIEW_DATA_MEASURE& arg);
