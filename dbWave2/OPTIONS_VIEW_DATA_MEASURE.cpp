...
IMPLEMENT_SERIAL(OPTIONS_VIEW_DATA_MEASURE, CObject, 0 /* schema number*/)

OPTIONS_VIEW_DATA_MEASURE::OPTIONS_VIEW_DATA_MEASURE()
= default;

OPTIONS_VIEW_DATA_MEASURE::~OPTIONS_VIEW_DATA_MEASURE()
= default;

OPTIONS_VIEW_DATA_MEASURE& OPTIONS_VIEW_DATA_MEASURE::operator =(const OPTIONS_VIEW_DATA_MEASURE& arg)
{
	if (this != &arg)
	{
...
void OPTIONS_VIEW_DATA_MEASURE::Serialize(CArchive& ar)
{
