...
TCHAR*	CADInputParmsDlg::pszAmplifier[]	= { _T("CyberAmp 320"),_T("Neurolog"),_T("IDAC"),_T("none"),_T(""),_T(""),_T(""),_T("")};
TCHAR*	CADInputParmsDlg::pszProbeType[]	= { _T("Taste01"),_T("DTP02"),_T("AI401"),_T("Neurolog"),_T("AD575"),_T(""),_T(""),_T("")};
