...
// WndVerticalHistogram.h : header file
// CWndVerticalHistogram button
//
// CWndVerticalHistogram build, stores and display a list of histograms
...
class CWndVerticalHistogram : public CScopeScreen
{
	// Construction
public:
	CWndVerticalHistogram();
	virtual ~CWndVerticalHistogram();
