...
HRESULT			SafeArrayPutName(SAFEARRAY* psa, long index, PCWSTR pszFirstName,  PCWSTR pszLastName); 
...
// 
//   PARAMETERS: 
//      * autoType - Could be one of these values: DISPATCH_PROPERTYGET, DISPATCH_PROPERTYPUT, DISPATCH_PROPERTYPUTREF, DISPATCH_METHOD. 
